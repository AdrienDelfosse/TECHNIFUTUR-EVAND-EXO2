...
import com.technipixl.technifutur_evand_exo2.databinding.FragmentTwitterBinding
...
class TwitterFragment : Fragment() {
    ...
    var binding:FragmentTwitterBinding? =null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding?.conexxionButton?.setOnClickListener {
            if(isLoginValide()){
                findNavController().navigate(TwitterFragmentDirections.actionTwitterFragmentToAfterLoginFragment())
            }else{
